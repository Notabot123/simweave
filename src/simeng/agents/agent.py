"""Routable agent that inherits from :class:`~simeng.core.entity.Entity`.
...
from simeng.agents.routing import a_star, NoPathError
...
class Agent(Entity):
    ...
    ----------
    graph:
        A simeng Graph, networkx graph, or dict-of-dict adjacency.
    start_node:
