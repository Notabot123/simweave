...
simweave uses a fixed-step *atomic* clock as its time authority. Every process
registered with the :class:`~simweave.core.environment.SimEnvironment` is
...
fast-forward idle gaps (see :mod:`simweave.core.scheduler`).
"""
