...
* **Locale-aware via babel** (optional, ``simweave[intl]``):
...
from simweave.currency.codes import get_decimals

if TYPE_CHECKING:
    from simweave.currency.money import Money
...
def _babel_format(money: "Money", locale: str) -> str:
    try:
        ...
        raise ImportError(
            ...
            "Install with `pip install simweave[intl]`."
        ) from exc
