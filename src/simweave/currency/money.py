...
from simweave.currency.codes import get_decimals, is_valid_currency

if TYPE_CHECKING:
    from datetime import datetime

    from simweave.currency.fx import FXConverter
...
class Money:
    ...
    currency:
        ...
        :func:`simweave.currency.codes.register_custom`.
    ...
    def __post_init__(self) -> None:
        ...
        if not is_valid_currency(code):
            raise ValueError(
                ...
                f"Use simweave.currency.register_custom({code!r}, decimals=...) "
                f"if intentional."
            )
    ...
    def __str__(self) -> str:
        ...
        from simweave.currency.format import format_money
